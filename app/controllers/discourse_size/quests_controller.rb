  ...
  class QuestsController < ::ApplicationController
    ...
    def index
      ...
      render json: {
               ...
               daily_reward_status:
                 (
                   if current_user.custom_fields["discourse_size_last_daily_reward_date"] ==
                        Date.today.to_s
                     "collected"
                   else
                     "available"
               ...
               can_reroll:
                 current_user.custom_fields["discourse_size_last_quest_reroll_date"] !=
                   Date.today.to_s,
               ...
               bonus_collected:
                 current_user.custom_fields["discourse_size_last_bonus_reward_date"] ==
                   Date.today.to_s,
             }
    end
